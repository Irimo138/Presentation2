...
<body id="page-top">
    ...
    @section('code')
         ...
         <div class="modal" id="loginModal" tabindex="0" aria-labelledby="loginModalLabel" aria-hidden="true">
         ...
         <div class="modal" id="RegisterModal" tabindex="0" aria-labelledby="RegisterModalLabel" aria-hidden="true">
            <div class="modal-dialog">
